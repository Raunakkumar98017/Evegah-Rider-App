...
class DashboardService {
  ...
  Future<Map<String, dynamic>?> fetchLiveVehicleDetails(String vehicleId) async {
    try {
      ...
      final qrDecryptedUri = Uri.parse("https://admin.evegah.com/api/qrDecrypted?access_token=$savedToken");
  ...
  Future<double> fetchWalletBalance() async {
    try {
      ...
      final uri = Uri.parse("https://admin.evegah.com/api/getUser?access_token=$savedToken");
      final response = await http.get(uri);
